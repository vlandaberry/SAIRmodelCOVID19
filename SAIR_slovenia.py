# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 17:47:19 2020
...
plot_series(I,slovenia,'all_inf_v_real_SAIR')
...
#plot series with real data and projection of infected
plot_series(I,slovenia,'last_inf_v_real_SAIR')

#plot series of projection of I,S and R
plot_curves(S,A,I,R,t,'last_SAIR')

plot_betas(test,slovenia,'betas_SAIR')
today_pred=I[len(slovenia)]
